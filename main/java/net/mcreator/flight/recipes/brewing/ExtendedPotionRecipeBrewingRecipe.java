...
package net.mcreator.flight.recipes.brewing;
...
public class ExtendedPotionRecipeBrewingRecipe implements IBrewingRecipe {
	@SubscribeEvent
	public static void init(FMLCommonSetupEvent event) {
		event.enqueueWork(() -> BrewingRecipeRegistry.addRecipe(new ExtendedPotionRecipeBrewingRecipe()));
	}
