...
public class FlightModFeatures {
	...
	static {
		REGISTRY.put(MysticalOreFeature.FEATURE, new FeatureRegistration(GenerationStep.Decoration.UNDERGROUND_ORES,
				MysticalOreFeature.GENERATE_BIOMES, MysticalOreFeature.CONFIGURED_FEATURE));
	}
